...
- `UniformPolygonConfig` or `ZonedPolygonConfig` define nominal surface fields.
  `simulate_surface_source()` rasterises at 1 m and applies a normalised
  inverse-square-inspired benchmark kernel using full FFT convolution.
